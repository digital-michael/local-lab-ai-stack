...
> **NOTE (retrofit 2026-06-22):** Session protocol is now governed by the LLM Agent Collaboration Framework.
> See: `/home/3pdx7/Documents/Entities/frameworks/llm-agent-framework/governance/agent-context-protocol.md`
> This section is retained for historical reference only. Active protocol is in `.github/copilot-instructions.md`.
...
- **Protocol definition (tooling-agnostic):** `llm-agent-framework/governance/agent-context-protocol.md`
