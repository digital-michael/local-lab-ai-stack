...
|---|---|---|---|
| BL-011 | P1 | Headscale migration: ACL hardening + LAN break-glass + IP migration | not started |
| BL-012 | P1 | Distributed node config: `node.sh configure` + `--refresh` | not started |
| BL-009 | P1 | Content Review Layer Phase 2 (guard LLM) | Phase 1 done `9d33dce` |
| BL-015 | P1 | Non-SSH CNC transport (replace tailscale SSH) | not started — design phase |
